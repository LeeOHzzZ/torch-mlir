""" This file contains an AnchorGenerator Class From
    https://www.internalfb.com/code/fbsource/fbcode/mobile-vision/maskrcnn-benchmark/maskrcnn_benchmark/modeling/rpn/anchor_generator.py
"""
#!/usr/bin/env python
...
def _generate_anchors(base_size, scales, aspect_ratios):
    ...
    print("before ratio_enum:", anchor)
    anchors = _ratio_enum(anchor, aspect_ratios)
    print("after ratio_enum:", anchors)
    anchors = np.vstack(
...
def _ratio_enum(anchor, ratios):
    ...
    # TODO: what does the following two lines do?
    # why ws is the square-root of the size-ratio but the height get multiplied by ratio?
